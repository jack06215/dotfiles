...
| package manifests | `Brewfile` (macOS: taps + formulae + casks + tap trust, regenerated by `generate-brewfile.sh`), `brew-formula-wsl2.txt` and `brew-trust-taps.txt` (Linux path) |
