...
class ChainFactory(Protocol):
    def __call__(
        self,
        *,
        template: BasePromptTemplate[RunnableSerializable[Any, Any]],
        chat: ChatLLM,
...
def _invoke_with_retry(
    *,
    ...
    template_holder: dict[str, BasePromptTemplate[RunnableSerializable[Any, Any]]],
    chat: ChatLLM,
    parser: RunnableSerializable[Any, Any],
...
def invoke_llm(
    *,
    template: BasePromptTemplate[RunnableSerializable[Any, str]],
    chat: ChatLLM,
...
def invoke_llm(
    *,
    template: BasePromptTemplate[RunnableSerializable[Any, T]],
    chat: ChatLLM,
